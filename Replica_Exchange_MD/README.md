...
* **Note:**
    ...
    [**The Complete Tutorial can be found here: **](https://github.com/NNairIITK/Enhanced_Sampling_Methods_Tutorials/blob/master/Replica_Exchange_MD/REMD_Tutorial.pdf)
